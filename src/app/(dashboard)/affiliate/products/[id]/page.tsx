          ...
          <table className="w-full text-sm">
            <thead style={{ background: "var(--bg-subtle)" }}>
              <tr>
                ...
                <th title="Product GMV tier for this month. Platinum: top 10%, Gold: top 30%, Silver: active but below top 30%, Bronze: low or zero GMV." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide cursor-help" style={{ color: "var(--text-secondary)" }}>Tier</th>
                <th title="Gross Merchandise Value — total sales (RM) generated by this product this month." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide cursor-help" style={{ color: "var(--text-secondary)" }}>GMV</th>
                <th title="Month-over-Month change in GMV vs the previous month. Green = growth, red = decline." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide cursor-help" style={{ color: "var(--text-secondary)" }}>MoM</th>
                <th title="Number of units sold this month." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide hidden sm:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>Items Sold</th>
                <th title="GMV ÷ Est. Commission — revenue generated per RM paid in commission for this product this month." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide hidden sm:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>ROI</th>
                <th title="Creator videos featuring this product this month." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide hidden md:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>Videos</th>
                <th title="Live streams featuring this product this month." className="px-2 sm:px-3 py-2 text-center text-xs font-semibold uppercase tracking-wide hidden md:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>Lives</th>
              </tr>
            </thead>
            <tbody>
              {[...data.history].reverse().map((h, i, arr) => {
                ...
                return (
                  <tr key={h.id} className="border-t" style={{ borderColor: "var(--border)" }}>
                    ...
                    <td className="px-2 sm:px-3 py-2 text-center"><TierChip tier={h.tier} /></td>
                    ...
                    <td className="px-2 sm:px-3 py-2 text-center whitespace-nowrap"><DeltaBadge pct={delta} /></td>
                    <td className="px-2 sm:px-3 py-2 text-center tabular-nums hidden sm:table-cell" style={{ color: "var(--text-secondary)" }}>{h.itemsSold.toLocaleString()}</td>
                    <td className="px-2 sm:px-3 py-2 text-center font-mono tabular-nums whitespace-nowrap hidden sm:table-cell" style={{ color: h.roi != null && h.roi >= 2 ? "#10b981" : h.roi != null && h.roi < 1 ? "#ef4444" : "var(--text-secondary)" }}>
                      {h.roi != null ? `${h.roi.toFixed(1)}x` : "—"}
                    </td>
                    <td className="px-2 sm:px-3 py-2 text-center tabular-nums hidden md:table-cell" style={{ color: "var(--text-secondary)" }}>{h.videos}</td>
                    <td className="px-2 sm:px-3 py-2 text-center tabular-nums hidden md:table-cell" style={{ color: "var(--text-secondary)" }}>{h.liveStreams}</td>
                  </tr>
                );
              })}
            </tbody>
