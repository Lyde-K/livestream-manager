        ...
        <div className="overflow-x-auto -mx-px">
          <table className="w-full text-sm">
            <thead style={{ background: "var(--bg-subtle)" }}>
              <tr>
                <th className="px-2 sm:px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide w-8" style={{ color: "var(--text-secondary)" }}>#</th>
                ...
                <SortableTh field="gmv" align="right" tooltip="Gross Merchandise Value — total sales (RM) generated by this product this period.">GMV</SortableTh>
                <th title="Month-over-Month change in GMV vs the previous period. Green = growth, red = decline." className="px-2 sm:px-3 py-2 text-right text-xs font-semibold uppercase tracking-wide cursor-help hidden sm:table-cell" style={{ color: "var(--text-secondary)" }}>MoM</th>
                <SortableTh field="roi" align="right" tooltip="GMV ÷ Est. Commission — revenue generated per RM paid in commission for this product.">ROI</SortableTh>
                <SortableTh field="itemsSold" align="right" tooltip="Total units sold this period.">Items</SortableTh>
                <th title="Creator videos featuring this product this period." className="px-2 sm:px-3 py-2 text-right text-xs font-semibold uppercase tracking-wide hidden sm:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>Videos</th>
                <th title="Live streams featuring this product this period." className="px-2 sm:px-3 py-2 text-right text-xs font-semibold uppercase tracking-wide hidden sm:table-cell cursor-help" style={{ color: "var(--text-secondary)" }}>Lives</th>
              </tr>
            </thead>
            <tbody>
              ...
              {rows.map((r, i) => {
                ...
                return (
                  <tr key={r.id} className="border-t cursor-pointer hover:bg-[var(--bg-subtle)] transition-colors" style={{ borderColor: "var(--border)" }}>
                    ...
                    <td className="px-2 sm:px-3 py-2 text-right whitespace-nowrap hidden sm:table-cell">
                      {mom != null ? (
                    ...
                    <td className="px-2 sm:px-3 py-2 text-right tabular-nums whitespace-nowrap" style={{ color: "var(--text-secondary)" }}>{r.itemsSold.toLocaleString()}</td>
